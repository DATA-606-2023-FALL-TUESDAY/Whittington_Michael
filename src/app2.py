...
st.header("NEISS Exploratory Data Analysis - Capstone Fall 2023")
st.subheader("This tool will also work on other datasets")
...
st.sidebar.header('Available Exploratory Options:')
